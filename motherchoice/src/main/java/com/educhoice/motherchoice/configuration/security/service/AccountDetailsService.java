...
public class AccountDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserBySocialId(long socialId, SocialSigninProviders providers) throws UsernameNotFoundException {
	    return new SecurityAccount(integratedUserQueryService.loadBySocialId(socialId, providers));
    }

    public SecurityAccount loadByFormLoginRequest(FormLoginRequestDto dto) throws UsernameNotFoundException {
